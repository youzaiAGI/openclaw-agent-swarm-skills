...
- `regression-swarm-concurrency.sh`: run 20 concurrent regression tasks (`codex` + `claude`) in a temporary git repo, poll convergence, verify write-task samples, then clean up temp repo.
