...
*   **语义化校验 (`dod.md`)**：你可以让 Agent 校验仓库中 `dod.md` 文件定义的复杂业务规则。
*   **对话示例**：“验证任务 `auth-fix` 的 DoD。如果测试通过且满足 `dod.md` 中的标准，则发布该分支。”
...
*   [问题排查手册](troubleshooting.md) - 解决文件锁、会话丢失等常见问题。
*   [状态协议 & JSON 格式](../skills/openclaw-agent-swarm/references/state-format.md) - 针对开发者的技术规范。
